...
''',
    ...
    # commands.py - 斜杠命令描述（COMMAND_REGISTRY）
    os.path.join("hermes_cli", "commands.py"): [
        # Session
        ...
        ('"Toggle codex app-server runtime for OpenAI/Codex models"',
         '"切换 OpenAI/Codex 模型的 codex app-server 运行环境"'),
        ('"Show Google Gemini Code Assist quota usage"',
         '"显示 Google Gemini Code Assist 配额使用情况"'),
        ...
        ('"Toggle fast mode — OpenAI Priority Processing / Anthropic Fast Mode (Normal/Fast)"',
         '"切换快速模式 — OpenAI 优先处理 / Anthropic 快速模式（正常/快速）"'),
        ...
        ('"Control what Enter does while Hermes is working"',
         '"控制 Hermes 工作时按 Enter 的行为"'),
        # Tools & Skills
        ('"Manage tools: /tools [list|disable|enable] [name...]"',
         '"管理工具：/tools [list|disable|enable] [名称...]"'),
